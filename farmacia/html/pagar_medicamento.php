        ...
        <div class="row">
            <div class="col-lg-12">
                <table class = "table table-striped table-hover">
                    <h1 style="text-align:center">Medicamento Pendiente de Pago</h1>
                            <tr>
        				    ...
        				    <tr>
                            <td>Nombre Estatico</td> <td>Codigo Estatico</td> <td>Cantidad</td> <td>Precio</td> <td><button class="btn" name="btn-pagar">Pagar</button></td>
                            </tr>
                            <tr>
                            <td>Nombre Estatico</td> <td>Codigo Estatico</td> <td>Cantidad</td> <td>Precio</td> <td><button class="btn" name="btn-pagar">Pagar</button></td>
                            </tr>
