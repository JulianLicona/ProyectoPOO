    ...
    <script>
        $(document).ready(function(){
            ...
            $("#btn-guardar").click(function(){
                var parametros = "txt-nombre="+$("#txt-nombre").val()+"&"+"txt-codigo="+$("#txt-codigo").val()+"&"+"txt-cantidad="+$("#txt-cantidad").val()+"&"+"txt-descripcion="+$("#txt-descripcion").val(); //formato similar a cuando se envia la informacion por GET
